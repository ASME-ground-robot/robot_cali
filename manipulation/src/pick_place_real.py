...
class Pick_Place_EE_Pose():
    ...
    def pregrasp(self):
        ...
        # self.pose_target.orientation.x = -0.006
        # self.pose_target.orientation.y = 0.081
        # self.pose_target.orientation.z = 0.070
        # self.pose_target.orientation.w = 0.994

        # self.pose_target.orientation.x = -0.010
        # self.pose_target.orientation.y = 0.149
        # self.pose_target.orientation.z = 0.069
        # self.pose_target.orientation.w = 0.986

        # self.pose_target.orientation.x = -0.012
        # self.pose_target.orientation.y = 0.171
        # self.pose_target.orientation.z = 0.069
        # self.pose_target.orientation.w = 0.983

        # self.pose_target.orientation.x = -0.018
        # self.pose_target.orientation.y = 0.260
        # self.pose_target.orientation.z = 0.068
        # self.pose_target.orientation.w = 0.963

        self.pose_target.orientation.x = -0.042
        self.pose_target.orientation.y = 0.673
        self.pose_target.orientation.z = 0.046
        self.pose_target.orientation.w = 0.737
